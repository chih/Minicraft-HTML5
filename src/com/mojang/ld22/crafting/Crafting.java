...
public class Crafting {
    ...
    static {
        try {
            workbenchRecipes.add(new FurnitureRecipe(FurnitureRecipe.FurnitureType.LANTERN).addCost(Resource.wood, 5).addCost(Resource.slime, 10).addCost(Resource.glass, 4));

            workbenchRecipes.add(new FurnitureRecipe(FurnitureRecipe.FurnitureType.OVEN).addCost(Resource.stone, 15));
            workbenchRecipes.add(new FurnitureRecipe(FurnitureRecipe.FurnitureType.FURNACE).addCost(Resource.stone, 20));
            workbenchRecipes.add(new FurnitureRecipe(FurnitureRecipe.FurnitureType.WORKBENCH).addCost(Resource.wood, 20));
            workbenchRecipes.add(new FurnitureRecipe(FurnitureRecipe.FurnitureType.CHEST).addCost(Resource.wood, 20));
            workbenchRecipes.add(new FurnitureRecipe(FurnitureRecipe.FurnitureType.ANVIL).addCost(Resource.ironIngot, 5));
